...
const { default: Plant } = require("../models/plant.js");
...
router.get("/plant", checkAuth, async (req, res) => {
...
router.post("/plant", checkAuth, async (req, res) => {

    try {

        const userId = req.userData._id;
        const userNick = req.userData.user_nick;
        var newPlant = req.body.newPlant;
      
        newPlant.plant_user_id = req.userData._id;
        newPlant.plant_date = Date.now();
    
        await createSaveRule(userId, userNick, newPlant.plant_id, true);
...
router.delete("/plant",checkAuth, async (req, res) => {
...
router.put("/plant",checkAuth, async (req, res) => {
